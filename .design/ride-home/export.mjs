...
const SLIDES = [
  ["Main",     "1-ten-people",    "h1-full-sky.png"],
  ["Station",  "2-seven-aboard",  "g1-iss-docked.png"],
  ["Lifeboat", "3-ride-home",     "f3-dragon.png"],
  ["Tiangong", "4-two-stations",  "g2-css-docked.png"],
  ["Cargo",    "5-bring-the-food","f6-progress.png"],
];
